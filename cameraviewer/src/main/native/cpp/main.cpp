...
namespace cv {
std::string_view GetResource_cv_16_png();
std::string_view GetResource_cv_32_png();
std::string_view GetResource_cv_48_png();
std::string_view GetResource_cv_64_png();
std::string_view GetResource_cv_128_png();
std::string_view GetResource_cv_256_png();
std::string_view GetResource_cv_512_png();
}  // namespace cv
...
static std::string MakeTitle(NT_Inst inst, nt::Event event) {
  ...
  if (mode & NT_NET_MODE_CLIENT3 || mode & NT_NET_MODE_CLIENT4) {
    if (event.Is(NT_EVENT_CONNECTED)) {
      return fmt::format("CameraViewer - NT Connected ({})",
                         event.GetConnectionInfo()->remote_ip);
    }
  }
  return "CameraViewer - NT DISCONNECTED";
}
...
int main(int argc, char** argv) {
  ...
  gui::AddIcon(cv::GetResource_cv_16_png());
  gui::AddIcon(cv::GetResource_cv_32_png());
  gui::AddIcon(cv::GetResource_cv_48_png());
  gui::AddIcon(cv::GetResource_cv_64_png());
  gui::AddIcon(cv::GetResource_cv_128_png());
  gui::AddIcon(cv::GetResource_cv_256_png());
  gui::AddIcon(cv::GetResource_cv_512_png());

  glass::SetStorageName("cameraviewer");
  ...
  gui::Initialize("CameraViewer - NT DISCONNECTED", 600, 400);
  gui::Main();
